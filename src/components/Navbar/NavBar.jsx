  ...
  return (
    <>
      <header className="header">
        ...
        <a href="#">
            <h1 className="header__nav-logo">gericht</h1>
          </a>
        ...
        >
          ...
          <ul className={`header__nav-links ${isNavOpen ? "active" : ""}`}>
          ...
          <svg
            className={`header__nav-menu ${isNavOpen ? "open" : ""}`}
            onClick={toggleNav}
            width="19"
            height="14"
            viewBox="0 0 19 14"
